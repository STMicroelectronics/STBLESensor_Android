...
import kotlinx.android.synthetic.main.fragment_color_ambient_light.*

@DemoDescriptionAnnotation(name = "Color Ambient Light", iconRes = R.drawable.ic_ambient_light,
        requareAll = [FeatureColorAmbientLight::class])
class ColorAmbientLightFragment : BaseDemoFragment() {
    ...
    private lateinit var progressBarIndex: ProgressBar
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        progressBarIndex = rootView.findViewById(R.id.progressBarUVIndex)
