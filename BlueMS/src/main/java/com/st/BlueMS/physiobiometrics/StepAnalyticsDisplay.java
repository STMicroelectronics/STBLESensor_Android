...
public class StepAnalyticsDisplay {
    ...
    public void results(Context context, TableLayout tl,  StepCalculations sc, double threshold, int sessionLength, String filename) {
        ...
        tl.addView(this.tableData(context,"Heel Strike Angular Velocity (AV)",df2.format(sc.meanAngularVelocity),"d/s"));
        tl.addView(this.tableData(context,"AV Standard deviation",df2.format(sc.stdAngularVelocity),"d/s"));
        tl.addView(this.tableData(context,"Coefficient of variation",df2.format(sc.coefVariation),"CV"));
    }

    public String results(StepCalculations sc, double threshold, int sessionLength, String filename) {
        ...
        results += "Heel Strike Angular Velocity (AV),"+df2.format(sc.meanAngularVelocity)+",d/s"+ System.getProperty("line.separator");
        results += "AV Standard deviation,"+df2.format(sc.stdAngularVelocity)+",d/s"+ System.getProperty("line.separator");
        results += "Coefficient of variation,"+df2.format(sc.coefVariation)+",CV"+ System.getProperty("line.separator");
        return results;
    }
}
