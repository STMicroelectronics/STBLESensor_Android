...
private val BLUE_ST_SDK_V2_BOARD_TYPE_IMAGES = mapOf(
    ...
    "STEVALROBKIT" to R.drawable.board_robkit1,
    "MEMSTWS2V0" to R.drawable.board_sensor_tile,
    "MEMSNDSG" to R.drawable.board_sensor_tile,
...
private val BLUE_ST_SDK_V2_BOARD_IMAGES = mapOf(
    ...
    "STEVALROBKIT" to R.drawable.real_board_robkit1,
    "MEMSTWS2V0" to R.drawable.real_board_tws,
    "MEMSNDSG" to R.drawable.real_board_ndsg,
