...
internal class  GLCubeRenderOld : GLSurfaceView.Renderer {
    private val TAG = GLCubeRenderOld::class.java.canonicalName
    ...
    override fun onSurfaceCreated(glUnused: GL10?, config: EGLConfig?) {
        ...
        val vertexShaderHandle = compileShader(
            ...
            readTextFileFromRawResource(mContext, R.raw.per_pixel_vertex_shader_head)
        )
        val fragmentShaderHandle = compileShader(
            GLES20.GL_FRAGMENT_SHADER,
            readTextFileFromRawResource(mContext, R.raw.per_pixel_fragment_shader_head)
        )
        ...
        mTextureDataHandle = loadTexture(mContext, R.drawable.texture_cube_face)
    }
